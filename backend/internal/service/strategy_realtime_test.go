...
func TestStrategyInstanceValidationDefaultsAndBoundaries(t *testing.T) {
	...
	livePayload := StrategyInstanceCreatePayload{
		Name: "Live protected", Mode: "manual", Environment: "live",
		TradingAccountID: "019d4000-0000-7000-8000-000000000003",
...
`, instrumentID).Error; err != nil {
	...
	workflowDefinition := db.WorkflowDefinition{
		...
		Code:        "m2-signal-workflow",
		Version:     1,
		DisplayName: "m2 signal workflow",
