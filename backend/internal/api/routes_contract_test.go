...
func TestRoutesExposeOnlyV2BaselineSurface(t *testing.T) {
	...
	for _, route := range []struct {
		...
		{http.MethodPost, "/api/v1/webhooks/1"},
		{http.MethodGet, "/api/v1/human-tasks"},
		{http.MethodPost, "/api/v1/human-tasks/1"},
		...
		{http.MethodGet, "/api/v1/workflows/1/batches"},
		{http.MethodPost, "/api/v1/workflows/1/batches"},
		{http.MethodGet, "/api/v1/workflows/1/activity"},
		{http.MethodGet, "/api/v1/workflows/1/activity/ws"},
		{http.MethodGet, "/api/v1/batches/1"},
