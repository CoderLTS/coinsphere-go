...
func (q *quantRuntime) registerOrderIntent(registrar sdk.Registrar) error {
	return registrar.Action(quantNodeMeta(sdk.NodeDescriptor{
		...
		ConfigSchema: json.RawMessage(`{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","properties":{"venue":{"type":"string","title":"交易所","pattern":"^[a-z][a-z0-9_-]{1,31}$","default":"binance"},"account":{"type":"string","title":"账户","pattern":"^[A-Za-z0-9][A-Za-z0-9._-]{0,63}$"},"market":{"type":"string","title":"市场类型","minLength":1,"maxLength":32},"instrument":{"type":"string","title":"交易对","pattern":"^[A-Z0-9]{2,32}$"},"quantity":{"type":"string","title":"数量","pattern":"^[0-9]+(?:\\.[0-9]+)?$","x-coinsphere-decimal":true,"default":"0"},"quoteAmount":{"type":"string","title":"报价金额","pattern":"^[0-9]+(?:\\.[0-9]+)?$","x-coinsphere-decimal":true,"default":"0"},"positionEffect":{"type":"string","title":"持仓操作","enum":["open","reduce"],"default":"open"}},"required":["venue","account","market","instrument","quantity","quoteAmount","positionEffect"],"additionalProperties":false}`),
