...
func registerInstrumentSync(registrar sdk.Registrar, runtime *binanceRuntime) error {
	return registrar.Action(withNodeMeta(sdk.NodeDescriptor{
		...
		ConfigSchema: json.RawMessage(`{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","properties":{"markets":{"type":"array","title":"Markets","items":{"type":"string","enum":["spot","usdm"]},"minItems":1,"maxItems":2,"uniqueItems":true,"default":["spot","usdm"]},"proxyId":{"type":"integer","title":"Proxy","minimum":0,"default":0,"x-coinsphere-proxy":true},"quoteAssets":{"type":"array","title":"Quote assets","items":{"type":"string"},"minItems":1,"maxItems":100,"default":["USDT","USDC"]},"baseAssetAllowlist":{"type":"array","items":{"type":"string"},"maxItems":1000,"default":[]},"baseAssetDenylist":{"type":"array","items":{"type":"string"},"maxItems":1000,"default":[]},"symbolAllowlist":{"type":"array","items":{"type":"string"},"maxItems":1000,"default":[]},"symbolDenylist":{"type":"array","items":{"type":"string"},"maxItems":1000,"default":[]}},"required":["markets","quoteAssets","baseAssetAllowlist","baseAssetDenylist","symbolAllowlist","symbolDenylist"],"additionalProperties":false}`),
